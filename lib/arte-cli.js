...
const search = async (url, bucket, artifact, version, metadata, exactMatch) => {
    try {
...
module.exports = {
    ...
    search: async (url, bucket, name, version, metadata, exactMatch) => {
        const progress = new Progress();
        ...
        try {
            ...
            const artifacts = await search(url, bucket, name, version, metadata, exactMatch);
